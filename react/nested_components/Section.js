    ...
    let sectionLink = (
      <Link to={section.sectionURL} onClick={this.handleMenu}>
        ...
        {section.image && (
          <img
            className={
              section.display && section.display == 'PC'
    ...
    if (this.props.width <= 991) {
      sectionLink = (
        <a
          ...
          onClick={e => this.clickSectionDropdown(e)}
        >
          {section.sectionTitle}
      ...
      <div className="dropdown-section">
        <div
          className={
            ...
            (section.sectionLinks.length > 0 ? 'hasItems' : '')
          }
        >
          {sectionLink}
        </div>
        <div
          className={
            ...
            (this.state.showSectionDropdown ? ' show ' : '')
          }
        >
          <div
                ...
                <span>
                  {section.sectionTitle &&
                    section.sectionTitle
                      ...
                      .charAt(0)
                      .toUpperCase() +
                      section.sectionTitle.toLowerCase().slice(1)}
                </span>
              </Link>
            )}
          </div>
          ...
          <div className="sectionLinks">
            {section.sectionLinks &&
              section.sectionLinks.map((link, linkKey) => {
                return (
                  <SectionLink
                    key={linkKey}
                    link={link}
